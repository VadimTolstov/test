package Ycheba.Collekcii.OcheredStek.Set;

//Исключаем все дубликаты из нашего Seta
...
class MainCar {
    ...
    public static void main(String[] args) {
        ...
        //Создаем Set он не хранит дублирующие данные
        Set<Car> carSet = new HashSet<>(carlist);//передаем в круглые скобки наш списак
        for (Car car: carSet){
