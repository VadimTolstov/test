...
//Коды ASCII-символов нижнего регистра отличаются от кодов соответствующих символов верхнего регистра на величину 32. Следовательно, для
...
//Остальные символы не должны меняться. Работа программы должна завершаться после того, как пользователь введет с клавиатуры точку. И наконец,
//сделайте так, чтобы программа отображала количество символов, для которых был изменен регистр.
//// Смена регистра символов

public class VvodSimvolovRegistr {
